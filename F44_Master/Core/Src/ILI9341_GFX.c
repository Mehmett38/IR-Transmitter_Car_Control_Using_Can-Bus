...
// Added by mehmet dinçer
void ILI9341_DrawImage2(const uint8_t* image, uint8_t orientation)
{
	ILI9341_SetRotation(SCREEN_VERTICAL_2);
	ILI9341_SetAddress(0,0,ILI9341_SCREEN_HEIGHT,ILI9341_SCREEN_WIDTH);
	...
	for(uint32_t i = 0; i < ILI9341_SCREEN_WIDTH*ILI9341_SCREEN_HEIGHT*2/BURST_MAX_SIZE; i++)
	{
		...
		if(i == 120*240*2/500)
		{
			ILI9341_SetAddress(0,160,ILI9341_SCREEN_HEIGHT,ILI9341_SCREEN_WIDTH);
